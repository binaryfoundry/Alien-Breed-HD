...
typedef struct {
    ...
    /* ab3d.ini (see settings.c): -1 = start_level=0, New Game starts level 1 */
    ...
    int16_t         cfg_gamepad_look_speed; /* ab3d.ini: gamepad right-stick look/turn speed percent */
    ...
    int16_t         cfg_volume;           /* ab3d.ini: master audio volume 0..100 (percent) */
